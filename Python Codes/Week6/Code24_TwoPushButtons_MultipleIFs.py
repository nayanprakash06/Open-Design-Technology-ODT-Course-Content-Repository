...
while True: #Infinte Loop to continously run the loop
    ...
    if val1 == 0 and val2 == 0:#Checking of both buttons are pressed
        print("Both Button Pressed")
    
    if val1 == 0 and val2 == 1:#Checking if only Button 1 is pressed
        print("only Button1 Pressed")
        
    if val1 == 1 and val2 == 0:#Checking if only Button 2 is pressed
